...
fit_ID3_acd <- svycdiff(NHANES2, "DR", a_mod_acd, s_mod_acd, y_mod_acd, 
...
mthds <- c("Multiple Regression", "IPTW Estimator", 
  ...
  "Proposed OM", "Proposed IPW1", "Proposed IPW2", "Proposed AIPW")
...
fit_ID3_ate <- svycdiff(NHANES3, "DR", a_mod_ate, s_mod_ate, y_mod_ate, 
                      
  "gaussian", "SDMVSTRA", "SDMVPSU")

fit2_ID3_ate <- svycdiff(NHANES3, "DR", a_mod2_ate, s_mod_ate, y_mod_ate, 
...
mthds <- c("Multiple Regression", 
  ...
  "Proposed AIPW", "Proposed AIPW w/ Race in Propensity Model")
...
NHANES_RESULTS_ATE <- rbind(res_lm_ate, res_iptw_ate, res_iptw_ate2, 
  ...
  fit_ID3_ate$cdiff[c(1:2)],  fit2_ID3_ate$cdiff[c(1:2)]
)
